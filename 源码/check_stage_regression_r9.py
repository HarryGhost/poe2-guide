...
with sync_playwright() as pw:
 ...
 page.locator('#search-open').click();page.locator('#site-search').fill('打造实例')
...
(OUT/'R9阶段与参考页回归.json').write_text(json.dumps(report,ensure_ascii=False,indent=2))
