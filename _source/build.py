...
NAV=[('剧情阶段',[('leveling','剧情练级 1级 → 通关')]),('异界阶段',[('start','阶段总览'),('upgrade','进阶条件与差异'),('skills','技能与精魂'),('gear','装备与独狼替代'),('tree','天赋与武器组'),('combat','实战与排障')]),('需要时查阅',[('craft','打造与涂膏'),('pitfalls','机制防坑'),('glossary','中英术语')]),('文件与依据',[('downloads','下载当前构筑'),('sources','来源与检查')])]
nav='';i=0
